...
public class SmokeSensor extends EchonetSuperDevice{
	public static final String MY_URI = EchonetOntology.NAMESPACE + "SmokeSensor";
	public static final String PROPERTY_HAS_DETECTION_THRESHOLD_LEVEL = EchonetOntology.NAMESPACE + "SmokeSensorHasDectectionThresholdLevel";
	public static final String PROPERTY_HAS_SMOKE_DETECTION_STATUS = EchonetOntology.NAMESPACE + "SmokeSensorHasSmokeDetectionStatus";
	public SmokeSensor() {
		super();
