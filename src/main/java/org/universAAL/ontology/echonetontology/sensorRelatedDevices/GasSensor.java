...
public class GasSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_GAS_DETECTION_STATUS = EchonetOntology.NAMESPACE + "hasGasDetectionStatus";
	public static final String PROPERTY_HAS_MEASURED_VALUE_OF_GAS_CONCENTRATION = EchonetOntology.NAMESPACE + "hasMeasuredValueOfGasConcentration";
	public GasSensor() {
		super();
	}
