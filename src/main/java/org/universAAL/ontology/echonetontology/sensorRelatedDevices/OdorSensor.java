...
public class OdorSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_ODOR_DETECTION_STATUS = EchonetOntology.NAMESPACE + "hasOdorDetectionStatus";
	public static final String PROPERTY_HAS_MEASURED_ODOR_VALUE = EchonetOntology.NAMESPACE + "hasMeasuredOdorValue";
	public OdorSensor() {
		super();
	}
