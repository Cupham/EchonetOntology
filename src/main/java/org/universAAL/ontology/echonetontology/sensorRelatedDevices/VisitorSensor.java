...
public class VisitorSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_VISITOR_DETECTION_STATUS = EchonetOntology.NAMESPACE + "hasVisitorDetectionStatus";
	public static final String PROPERTY_HAS_VISITOR_DETECTION_HOLDING_TIME = EchonetOntology.NAMESPACE + "hasVisitorDetectionHoldingTime";
