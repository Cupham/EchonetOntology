...
public class CallSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_CALL_STATUS = EchonetOntology.NAMESPACE + "hasCallStatus";
	public static final String PROPERTY_HAS_CALL_HOLDING_TIME = EchonetOntology.NAMESPACE + "hasCallHoldingTime";
	public CallSensor() {
		super();
	}
